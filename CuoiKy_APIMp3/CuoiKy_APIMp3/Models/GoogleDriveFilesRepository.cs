...
namespace CuoiKy_APIMp3.Models
{
    public class GoogleDriveFilesRepository
    {
        ...
        public static DriveService GetService()
        {
            ...
            using (var stream = new FileStream(@"C:\Users\vulinhchi\Documents\CuoiKy_APIMp3\CuoiKy_APIMp3\client_secret_vulinhchi0vlc.json", FileMode.Open, FileAccess.Read))
            {
                String FolderPath = @"C:\Users\vulinhchi\Documents";
                String FilePath = Path.Combine(FolderPath, "DriveServiceCredentials_0vlc1.json");
